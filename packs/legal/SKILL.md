...
What survives gets 0–100 — your own confidence, and nothing is dropped for being low. A wrong legal finding gets a product changed and a conversion rate dropped for a rule that was never there, and the defence against that is the rule you cite, not the number you give yourself: cite the provision, or do not write the finding.
