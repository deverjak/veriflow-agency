...
**Přejímka:** [`../prejimka-outputs.md`](../prejimka-outputs.md) — pět bodů §7 s tím, kde je každý dokázaný, pět míst, kde plán neměl pravdu, a co může říct jen ostrý provoz.
